...
export const DOMAIN_RULES: DomainRule[] = [
  ...
  {
    id: 'leoradiadores',
    hostnames: ['leoradiadores.com.uy', 'www.leoradiadores.com.uy'],
  ...
  {
    id: 'diegoradiadores',
    hostnames: ['diegoradiadores.com.uy', 'www.diegoradiadores.com.uy'],
    seedUrls: ['https://diegoradiadores.com.uy/tienda/'],
    preferredMethod: 'http',
    preserveOutOfStock: true,
    productUrlPatterns: [/\/producto\/[^/?#]+\/?$/i],
    categoryUrlPatterns: [/\/(?:tienda|categoria-producto|product-category)(?:\/|\?|$)/i, /\/tienda\/page\/\d+\/?$/i],
    excludeUrlPatterns: [/\/cart/i, /\/carrito/i, /\/checkout/i, /\/mi-cuenta/i, /\/my-account/i, /\/contacto/i, /\/blog/i, /[?&]add-to-cart=/i],
...
function formatHouseLabel(id: string): string {
  const explicitLabels: Record<string, string> = {
    multishop: 'Multishop',
    leoradiadores: 'Leo Radiadores',
    diegoradiadores: 'Diego Radiadores',
    cymaco: 'Cymaco',
    familcar: 'Familcar',
    larrique: 'Larrique',
    yaguaron: 'Yaguarón',
